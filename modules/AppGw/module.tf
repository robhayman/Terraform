resource "azurerm_application_gateway" "network" {
  ...
  dynamic "backend_http_settings" {
    ...
    port                           = backend_http_settings.value.value.port
    protocol                       = backend_http_settings.value.value.protocol
    request_timeout                = backend_http_settings.value.value.request_timeout
    }
  }
